...
docs/EVAL.md                the evaluation set and how to run it
docs/RUNBOOK.md             incident playbooks
worker/src/ibvap_worker/    the analytics pipeline (34 modules)
api/src/ibvap_api/          FastAPI: REST, WebSocket, verification (18 modules)
...
**545 Python tests + 6 TypeScript tests**, all passing with no infrastructure required —
...
| [`docs/EVAL.md`](docs/EVAL.md) | The evaluation set, metrics, and how to run it |
| [`docs/RUNBOOK.md`](docs/RUNBOOK.md) | Incident playbooks — what to actually type when something's wrong |
| [`docs/RUN.md`](docs/RUN.md) | How to run the stack from WSL against this Windows checkout |
